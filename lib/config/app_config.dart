...
class AppConfig {
  ...
  /// Tiempo real: true para usar Pusher (notificaciones y eventos de dominio).
  ...
  static String get appName => dotenv.env['APP_NAME'] ?? 'App Scaffold';
  ...
  static String get supportUrl =>
      dotenv.env['SUPPORT_URL'] ?? 'https://example.com/soporte';
  static String get supportEmail =>
      dotenv.env['SUPPORT_EMAIL'] ?? 'soporte@example.com';
}
