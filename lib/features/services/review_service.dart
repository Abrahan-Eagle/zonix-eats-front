...
class ReviewService {
  ...
  Future<Map<String, dynamic>> createReview({
    ...
    final url = Uri.parse('$_baseUrl/api/buyer/reviews');
  ...
  Future<List<Map<String, dynamic>>> getReviews(int reviewableId, String reviewableType) async {
    final headers = await AuthHelper.getAuthHeaders();
    final url = Uri.parse('$_baseUrl/api/buyer/reviews/$reviewableId/$reviewableType');
  ...
  Future<Map<String, dynamic>> updateReview({
    ...
    final headers = await AuthHelper.getAuthHeaders();
    final url = Uri.parse('$_baseUrl/api/buyer/reviews/$reviewId');
  ...
  Future<bool> canReview(int reviewableId, String reviewableType) async {
    final headers = await AuthHelper.getAuthHeaders();
    final url = Uri.parse('$_baseUrl/api/buyer/reviews/$reviewableId/$reviewableType/can-review');
    final response = await http.get(
      url,
      headers: headers,
    );
