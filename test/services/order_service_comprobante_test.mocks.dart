...
class MockOrderService extends _i1.Mock implements _i3.OrderService {
  ...
  @override
  _i4.Future<Map<String, dynamic>?> calculateDeliveryFee({
  ...
  @override
  _i4.Future<List<Map<String, dynamic>>> getAvailablePaymentMethodsForOrder(
          int? orderId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAvailablePaymentMethodsForOrder,
          [orderId],
        ),
  ...
  @override
  _i4.Future<Map<String, dynamic>?> getPaymentInfo(int? orderId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPaymentInfo,
          [orderId],
  ...
  @override
  _i4.Future<Map<String, dynamic>?> getDeliveryAgentForOrder(int? orderId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getDeliveryAgentForOrder,
          [orderId],
        ),
        returnValue: _i4.Future<Map<String, dynamic>?>.value(),
      ) as _i4.Future<Map<String, dynamic>?>);
